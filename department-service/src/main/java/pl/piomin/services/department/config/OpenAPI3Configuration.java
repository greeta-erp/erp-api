...
@OpenAPIDefinition(servers = { @Server(url = "https://erp.greeta.net")}, info = @Info(title = "Department Service APIs", description = "This lists all the Department Service API Calls. The Calls are OAuth2 secured, "
